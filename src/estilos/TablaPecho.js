  ...
  return (
    <div className="table2-container">
      <table className="table2">
        <tbody>
          <tr>
            <th className="table2-style">PECHO</th>
          ...
          <tr>
            <td className="table2-cyan">25 Pecho</td>
          ...
          <tr>
            <td className="table2-cyan">50 Pecho</td>
            <td className="table2-goal">
              <input
                type="text"
                pattern="^([0-5]\d):([0-5]\d):([0-9][0-9]|[0-8][0-9]|99)$"
          ...
          <tr>
            <td className="table2-cyan">100 Pecho</td>
            <td className="table2-goal">
              <input
                type="text"
                pattern="^([0-5]\d):([0-5]\d):([0-9][0-9]|[0-8][0-9]|99)$"
          ...
          <tr>
            <td className="table2-cyan">200 Pecho</td>
            <td className="table2-goal">
              <input
                type="text"
                pattern="^([0-5]\d):([0-5]\d):([0-9][0-9]|[0-8][0-9]|99)$"
